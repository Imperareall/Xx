...
export default function DetailView() {
  ...
  // Prevent clicks inside DetailView from reaching anything behind it
      ...
      {isOpen && (
        ...
        >
          ...
          <div style={{ flex: 1, position: 'relative', overflow: 'hidden' }}>
            {/* 图片 — 用 activeId 做 key 实现 crossfade */}
            <motion.img
              key={activeId}
              src={current!.imgSrc}
              alt={current!.imgAlt}
            ...
            <div style={{
              ...
              inset: 0,
              background:
                'linear-gradient(to top, rgba(10,10,11,0.92) 0%, rgba(10,10,11,0.1) 50%, transparent 65%)',
              pointerEvents: 'none',
            }} />
            ...
            <div style={{
              ...
              <p style={{
                ...
                color: 'rgba(231,216,201,0.55)', marginBottom: '12px',
              }}>
                {current!.date}
                {current!.subtitle && ` · ${current!.subtitle}`}
              </p>
              <p style={{
                fontSize: '13px', fontWeight: 300, color: 'rgba(245,245,245,0.5)',
                maxWidth: '480px', margin: '0 auto', lineHeight: 1.9, letterSpacing: '0.06em',
                whiteSpace: 'pre-line',
              }}>
                {current!.description}
              </p>
            ...
            <button
              ...
              style={{
                ...
                width: '18%', minWidth: '60px', cursor: 'pointer', zIndex: 5,
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '14px', minWidth: '140px' }}>
              <span style={{
                fontSize: '12px', fontWeight: 300, letterSpacing: '0.3em',
              ...
              <div style={{
                ...
                <motion.div
                  ...
                  style={{
                    ...
                    background: 'rgba(231,216,201,0.7)', borderRadius: '1px',
                  }}
                />
              </div>
              <span style={{
                fontSize: '10px', fontWeight: 300, letterSpacing: '0.3em',
                color: 'rgba(245,245,245,0.25)', fontVariantNumeric: 'tabular-nums',
              }}>
              ...
              {memories.map((m, i) => {
                ...
                return (
                  <button
                    ...
                    style={{
                      width: '32px', height: '22px', borderRadius: '2px',
                      overflow: 'hidden', flexShrink: 0, padding: 0,
                      cursor: 'pointer', background: 'transparent',
                      border: active ? '1.5px solid rgba(231,216,201,0.8)' : '1px solid transparent',
